...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--start_index', type=int, default=None, help='index of val fold to start')
        parser.add_argument('--val_index', type=int, default=None, help='index of val fold, higher priority than start_index')
        ...
        parser.add_argument('--log_time', action='store_true', help='save log file into different files by time')
        parser.add_argument('--augmentations', type=str, default='', help='augmentations to specify, e.g. 12,14')
        parser.add_argument('--best_metrics', type=str, default='dice', help='the metrics used to find best epoch')
